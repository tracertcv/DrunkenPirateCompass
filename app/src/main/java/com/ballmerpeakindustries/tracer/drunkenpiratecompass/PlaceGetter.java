...
public class PlaceGetter extends AsyncTask<String, Void, String> {
    ...
    public PlaceGetter(ArrayList<Place> p, Location l, String s){
        placeList = p;
        location = l;
        lastJSONResponse = s;
    }
    ...
    protected void onPostExecute(String placesResponse){
        try{
            //TextView display = (TextView) findViewById(R.id.places);
            ...
            System.out.println(placeList.toString()+lastJSONResponse);
